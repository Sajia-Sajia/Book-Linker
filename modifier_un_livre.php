...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($titre) && empty($isbn) && empty($auteur) && empty($categorie) && empty($description)) {
        ...
        $isbnPattern = "/^[0-9]{10}$/"; // Format ISBN à 10 chiffres
       // Format URL de l'image
        ...
        if (!preg_match($isbnPattern, $isbn)) {
            ...
            $sql = "UPDATE livre SET titre = :titre, auteur = :auteur, catégorie = :categorie, description = :description WHERE isbn = :isbn";
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <div class="form-actions">
            ...
            <a href="recherchead.php"><i class="fas fa-arrow-left back-arrow"></i></a>
        </div>
    </form>
</div>
